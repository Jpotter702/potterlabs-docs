    ...
    <DocsLayout>
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbPage>Story Scenes</BreadcrumbPage></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">Story Scenes</h1>
        <p className="text-lg text-slate-600 dark:text-slate-300">Generate vivid scene descriptions with settings, atmosphere, and visual details.</p>
      </header>
      <div className="prose dark:prose-invert max-w-none">
        <h2>Endpoint</h2>
        <pre className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg"><code>POST https://api.potterlabs.xyz/v1/story/scenes</code></pre>
        <p>Create immersive scene descriptions and settings for your stories.</p>
