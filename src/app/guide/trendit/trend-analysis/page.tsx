  ...
  return (
    <DocsLayout>
      ...
      <header className="mb-8">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300">Track and analyze trending topics, keywords, and discussions across Reddit over time.</p>
      </header>
      <div className="prose dark:prose-invert max-w-none">
        <h2>Endpoint</h2>
        <pre className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg"><code>POST https://api.potterlabs.xyz/v1/trendit/trends</code></pre>
        <p>Identify trending topics and analyze their growth patterns across Reddit communities.</p>
