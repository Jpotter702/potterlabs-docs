  ...
  return (
    <DocsLayout>
      ...
      <header className="mb-8">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300">Create and manage automated agents for continuous Reddit monitoring and data collection.</p>
      </header>
      <div className="prose dark:prose-invert max-w-none">
        <h2>Endpoint</h2>
        <pre className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg"><code>POST https://api.potterlabs.xyz/v1/trendit/agents</code></pre>
        <p>Deploy intelligent agents for automated Reddit monitoring with custom triggers and actions.</p>
